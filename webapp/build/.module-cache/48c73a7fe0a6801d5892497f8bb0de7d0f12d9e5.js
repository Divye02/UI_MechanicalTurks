...
var Imagepos = React.createClass({displayName: "Imagepos",
	...
	handleChange: function(event){
			...
			else if(this.state.clicks == 1 && !this.state.removeBox){
				this.setState({
			...
			if(this.state.removeBox){
				var c = document.getElementById("cross");
					...
					console.log(this.state.width);
					console.log(this.state.height);
					ctx.clearRect(this.state.x_axis-1, this.state.y_axis-1, this.state.width+2, this.state.height+2);
			}
			else{
				document.getElementById("cross").onclick = function() { return false; } ;
			}	
	...
	handleClick: function(){
		this.setState({removeBox: true}, function(){
	...
	render:function(){		
		...
		return(		React.createElement("div", null, 
					...
					React.createElement("img", {src: "test.png", id: "cross2", onClick: this.handleChange}), 	
					React.createElement("canvas", {width: "550", height: "600", id: "cross", onClick: this.handleChange}), 
