...
var Imagepos = React.createClass({displayName: "Imagepos",
	...
	render:function(){		
		return(		React.createElement("div", {className: "img"}, 
					React.createElement("img", {src: "test.png", id: "cross", onClick: this.handleChange}), 
...
var BoundingBox = React.createClass({displayName: "BoundingBox",
	...
	render : function(){
		...
		return (
			React.createElement("canvas", {id: "img", className: "myCanvas", width: this.state.width, height: this.state.height, onLoad: this.handleChange})
			);
	}
});
...
React.render(React.createElement(SubmitB, {id: "main"}) , document.getElementById('main'));
