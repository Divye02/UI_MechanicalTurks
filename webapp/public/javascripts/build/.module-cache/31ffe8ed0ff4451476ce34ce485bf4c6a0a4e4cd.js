var SubmitB = React.createClass({displayName: "SubmitB",
	getInitialState: function(){
		return{value: '',  text: false, para: '', position: []};
	},
  ...
  render: function() {
    return (
      React.createElement("div", null, 
        ...
        React.createElement(FinalKeywords, {items: this.state.items}), 
...
React.render(React.createElement(Keywords, null) , document.getElementById('fontSize'));
