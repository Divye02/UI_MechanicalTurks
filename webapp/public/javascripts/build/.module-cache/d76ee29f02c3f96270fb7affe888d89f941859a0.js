...
var BoundingBox = React.createClass({displayName: "BoundingBox",
	...
	handleChange: function(){
		...
		ctx.rect(this.state.x_axis + 606, this.state.y_axis + 75, this.state.width, this.state.height);
		ctx.stroke();
	},
	render : function(){

		return (
			React.createElement("canvas", {id: "cross", className: "myCanvas", width: this.state.width, height: this.state.height, onLoad: this.handleChange})
			);
	}
});
