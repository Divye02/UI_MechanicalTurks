...
var Imagepos = React.createClass({displayName: "Imagepos",
	...
	render:function(){		
		return(		React.createElement("div", null, 
					React.createElement("img", {src: "test.png", id: "cross", onClick: this.handleChange}), 	
					React.createElement(BoundingBox, {id: "cross", x_axis: this.state.x_axis, onClick: this.handleChange, y_axis: this.state.y_axis, width: this.state.width, height: this.state.height})	
					)
			);
	}
});
...
var BoundingBox = React.createClass({displayName: "BoundingBox",
	...
	render : function(){
		...
		return (React.createElement(SVGComponent, {className: "top"}, 
