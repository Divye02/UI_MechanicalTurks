...
var Imagepos = React.createClass({displayName: "Imagepos",
	...
	render:function(){		
		return(		React.createElement("div", null, 
					...
					React.createElement("img", {src: "test.png", id: "cross", onClick: this.handleChange}), 	
					React.createElement(BoundingBox, {x_axis: this.state.x_axis, onClick: this.handleChange, y_axis: this.state.y_axis, width: this.state.width, height: this.state.height})	
					)
			);
	}
});
...
var BoundingBox = React.createClass({displayName: "BoundingBox",
	...
	render : function(){
		...
		return (React.createElement(SVGComponent, {id: "cross", className: "top", onClick: this.props.onSomeEvent}, 
        		React.createElement(Rectangle, {height: this.state.height, width: this.state.width, x: this.state.x_axis, y: this.state.y_axis, fill: "none", stroke: "#ff0099", zIndex: "3"})
    			)
