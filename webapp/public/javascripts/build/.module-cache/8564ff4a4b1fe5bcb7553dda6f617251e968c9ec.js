...
var BoundingBox = React.createClass({displayName: "BoundingBox",
	...
	render : function(){
		...
		return (React.createElement(SVGComponent, {height: "100", width: "100"}, 
        		React.createElement(Rectangle, {id: "myCanvas", height: "50", width: "50", x: "25", y: "25", fill: "none", stroke: "#ff0099", zIndex: "3"})
    			)
