...
var Imagepos = React.createClass({displayName: "Imagepos",
	getInitialState: function(){
		return {position: this.props.value, clicks: 0, x_axis: 10, y_axis: 10, height: 0, width: 0};
	},
...
var BoundingBox = React.createClass({displayName: "BoundingBox",
	...
	render : function(){
		...
		return (
			React.createElement("canvas", {id: "myCanvas", width: this.state.width, height: this.state.height, onLoad: this.handleChange})
			);
	}
});
