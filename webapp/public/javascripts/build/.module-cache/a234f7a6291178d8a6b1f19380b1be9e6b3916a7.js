...
var BoundingBox = React.createClass({displayName: "BoundingBox",
	...
	render : function(){
		...
		return (React.createElement(SVGComponent, {id: "cross", className: "top", height: "560", width: "420", x: "1000", y: "100"}, 
        		React.createElement(Rectangle, {height: "50", width: "50", x: "50", y: "25", fill: "none", stroke: "#ff0099", zIndex: "3"})
    			)
