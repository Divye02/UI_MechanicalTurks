...
var Imagepos = React.createClass({displayName: "Imagepos",
	...
	render:function(){		
		return(		React.createElement("div", {id: "container"}, 
   				 ...
   				 React.createElement("button", {id: "add-rect", onClick: this.handleClick}, "Add rect"), 
   				 React.createElement("button", {id: "remove-rect", disabled: true, onClick: this.handleClick}, "Remove rect")
)
			);
	}
});
